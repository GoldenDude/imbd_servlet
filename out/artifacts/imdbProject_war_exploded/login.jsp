...
<%
	...
	if(session.getAttribute("validation") != null) {
		...
		if (!validate) {
			isMsg = true;
			classType = "loginError";
			msg = "WRONG USER NAME OR PASSWORD!";
		}
	}

	if(request.getAttribute("registerResult") != null) {
		boolean registerResult = (boolean) request.getAttribute("registerResult");
		isMsg = true;
		if (registerResult) {
			classType = "registerSuccess";
			msg = "Successfully registered";
		}
		else {
			classType = "loginError";
			msg = "USER NAME OR MAIL ALREADY TAKEN";
		}
	}
			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
				<form class="login100-form validate-form" action = "validate" method="post">
					...
					<%
						if(isMsg){
					%>
					<label class=<%=classType%>><%=msg%></label>
					<%
						}
					%>
